...
[BASE] = LAYOUT_gergoplex(
    ...
    MT(MOD_RSFT, KC_Z),KC_X, KC_C, KC_V, KC_V,  	KC_K, KC_H, KC_COMM, KC_DOT, MT(MOD_RSFT, KC_SLSH),
...
[NUMB] = LAYOUT_gergoplex(
    KC_1,  KC_7,  KC_8,  KC_9,  KC_5,		 		KC_6,  	KC_7, 	 KC_8, 		KC_9, 	 KC_0,
    KC_F1, KC_4, KC_5, KC_6, KC_F5,   		KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_VOLU,
    KC_F6, KC_1, KC_2, KC_3, KC_F10,  		KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_VOLD,
