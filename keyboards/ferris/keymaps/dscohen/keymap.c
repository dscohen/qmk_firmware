...
const uint16_t PROGMEM quote_combo[] =        {KC_U, KC_E, COMBO_END};
...
[_QWERTY] = LAYOUT(
  ...
  MT(MOD_LALT, KC_Z),    KC_X,    KC_C,    KC_D,    KC_V,              KC_K,    KC_H,    KC_COMM, KC_DOT,  MT(MOD_LALT, KC_SLSH),
                    LT(_NAV,KC_BSPC), LT(_SYMB,KC_F24),            LT(_NUM, KC_SPACE), LT(_TMUX,KC_LGUI)
),
...
[_NAV] = LAYOUT(
    ...
    SGUI(KC_UP),   LCA(KC_LEFT),  LCA(KC_F),    LCA(KC_RGHT),   SGUI(KC_DOWN),   	KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, OSM(MOD_LGUI),
...
KC_EXLM, KC_AT,   KC_LCBR, KC_RCBR, KC_PIPE,   KC_GRV,  KC_TILD, KC_TRNS, KC_TRNS, KC_BSLS,
    ...
    KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, KC_BTN1,   KC_AMPR, KC_EQL,  KC_COMM, KC_DOT,  KC_MINS,
                       KC_SCLN, KC_LGUI,   MO(_NUM),  KC_SCLN
    ),
[_TMUX] = LAYOUT( 
//---------+---------+---------+---------+---------         ---------+---------+---------+---------+---------//
...
[_GAME] = LAYOUT(
  ...
  KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,              KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH,
                     MT(MOD_LCTL,KC_ESC), KC_SPACE,            KC_SPACE, TG(_GAME)
),
};
